# Repro project for SPR-13516

Run the project with `mvn package cargo:run -Ptomcat8`.

The project will be available at: http://localhost:8080/SPR-13516/

The static resource is available at: http://localhost:8080/SPR-13516/resources/spring.css
