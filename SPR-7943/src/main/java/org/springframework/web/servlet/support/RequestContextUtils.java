...
public abstract class RequestContextUtils {
	...
	/**
	 * Return the ParameterHandler that has been bound to the request 
	 * by the DispatcherServlet.
	 * @param request current HTTP request
	 * @return the current parameter's handler
	 */
	public static ParameterHandler getParameterHandler(HttpServletRequest request) {
		return (ParameterHandler) request.getAttribute(DispatcherServlet.PARAMETER_HANDLER_SOURCE_ATTRIBUTE);
	}
}
