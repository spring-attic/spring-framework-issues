# Repro project for SPR-11193

The project will be available at: http://localhost:8080/SPR-11193/

* for a JSON response with a custom HTTP status: http://localhost:8080/SPR-11193/status
* for a mapped exception with a custom HTTP status: http://localhost:8080/SPR-11193/exception  
